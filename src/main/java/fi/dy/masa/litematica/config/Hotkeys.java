...
public class Hotkeys
{
    ...
    public static final ConfigHotkey PRINTER_ACTIVATION                 = new ConfigHotkey("printerActivation",                 "",             KeybindSettings.PRESS_ALLOWEXTRA_EMPTY, "Hold to automatically place nearby missing schematic blocks inside the current render layer range");
    public static final ConfigHotkey PRINTER_TOGGLE                     = new ConfigHotkey("printerToggle",                     "",             KeybindSettings.PRESS_ALLOWEXTRA_EMPTY, "Toggle automatic schematic printing on or off");
